        ...
        if self.color == tour:
            if self.click == 0:
                ...
                if self.position[0] > 0:
                    ...
                    elif conf[self.position[0] - 1][self.position[1]][2] == False and \
                            conf[self.position[0] - 1][self.position[1]][3].color != "" and \
                            conf[self.position[0] - 1][self.position[1]][3].color != self.color:
                        conf[self.position[0] - 1][self.position[1]][0].config(
                            bg=b[conf[self.position[0] - 1][self.position[1]][1]])
                ...
                if self.position[1] > 0:
                    if conf[self.position[0]][self.position[1] - 1][2] == True:
                        conf[self.position[0]][self.position[1] - 1][0].config(
                            bg=k[conf[self.position[0]][self.position[1] - 1][1]])
                    elif conf[self.position[0]][self.position[1] - 1][2] == False and \
                            conf[self.position[0]][self.position[1] - 1][3].color != "" and \
                            conf[self.position[0]][self.position[1] - 1][3].color != self.color:
                        conf[self.position[0]][self.position[1] - 1][0].config(
                            bg=b[conf[self.position[0]][self.position[1] - 1][1]])
                ...
                if self.position[0] > 0 and self.position[1] > 0:
                    if conf[self.position[0] - 1][self.position[1] - 1][2] == True:
                        conf[self.position[0] - 1][self.position[1] - 1][0].config(
                            bg=k[conf[self.position[0] - 1][self.position[1] - 1][1]])
                    elif conf[self.position[0] - 1][self.position[1] - 1][2] == False and \
                ...
                if self.position[0] > 0 and self.position[1] < 7:
                    if conf[self.position[0] - 1][self.position[1] + 1][2] == True:
                        ...
                        conf[self.position[0] - 1][self.position[1] + 1][0].config(
                            bg=b[conf[self.position[0] - 1][self.position[1] + 1][1]])
                if self.color == "White" and self.moves == 0 and conf[0][5][2] == True and conf[0][6][2] == True and \
                        conf[0][7][2] == False:
                    if conf[0][7][3].moves == 0:
                        conf[0][7][0].config(bg=k[conf[0][7][1]])
                if self.color == "White" and self.moves == 0 and conf[0][1][2] == True and conf[0][2][2] == True and \
                        conf[0][3][2] == True and conf[0][0][2] == False:
                    if conf[0][0][3].moves == 0:
                        conf[0][0][0].config(bg=k[conf[0][0][1]])
                if self.color == "Black" and self.moves == 0 and conf[7][5][2] == True and conf[7][6][2] == True and \
                        conf[7][7][2] == False:
                    if conf[7][7][3].moves == 0:
                        conf[7][7][0].config(bg=k[conf[7][7][1]])
                if self.color == "Black" and self.moves == 0 and conf[7][1][2] == True and conf[7][2][2] == True and \
                        conf[7][3][2] == True and conf[7][0][2] == False:
                ...
                if self.position[0] > 0:
                    conf[self.position[0] - 1][self.position[1]][0].config(
                        bg=conf[self.position[0] - 1][self.position[1]][1])
                if self.position[0] < 7:
                    conf[self.position[0] + 1][self.position[1]][0].config(
                        bg=conf[self.position[0] + 1][self.position[1]][1])
                if self.position[1] > 0:
                    conf[self.position[0]][self.position[1] - 1][0].config(
                        bg=conf[self.position[0]][self.position[1] - 1][1])
                if self.position[1] < 7:
                    conf[self.position[0]][self.position[1] + 1][0].config(
                        bg=conf[self.position[0]][self.position[1] + 1][1])
                if self.position[0] > 0 and self.position[1] > 0:
                    conf[self.position[0] - 1][self.position[1] - 1][0].config(
                        bg=conf[self.position[0] - 1][self.position[1] - 1][1])
                if self.position[0] < 7 and self.position[1] < 7:
                    conf[self.position[0] + 1][self.position[1] + 1][0].config(
                        bg=conf[self.position[0] + 1][self.position[1] + 1][1])
                if self.position[0] < 7 and self.position[1] > 0:
        ...
        if self.color == tour:
            if self.click == 0:
                ...
                for i in range(self.position[0]):
                    ...
                    elif conf[self.position[0] - 1 - i][self.position[1]][2] == False and \
                            conf[self.position[0] - 1 - i][self.position[1]][3].color != "" and \
                            conf[self.position[0] - 1 - i][self.position[1]][3].color != self.color:
                        conf[self.position[0] - 1 - i][self.position[1]][0].config(
                            bg=b[conf[self.position[0] - 1 - i][self.position[1]][1]])
                        break
                    else:
                        break
                ...
                for i in range(self.position[1]):
                    ...
                    elif conf[self.position[0]][self.position[1] - 1 - i][2] == False and \
                            conf[self.position[0]][self.position[1] - 1 - i][3].color != "" and \
                            conf[self.position[0]][self.position[1] - 1 - i][3].color != self.color:
                        conf[self.position[0]][self.position[1] - 1 - i][0].config(
                            bg=b[conf[self.position[0]][self.position[1] - 1 - i][1]])
                        break
                    else:
                        break
        ...
        if self.color == tour:
            if self.click == 0:
                ...
                if self.position[0] > 0 and self.position[1] > 1:
                    ...
                    if conf[self.position[0] - 1][self.position[1] - 2][2] == False and \
                            conf[self.position[0] - 1][self.position[1] - 2][3].color != "" and \
                            conf[self.position[0] - 1][self.position[1] - 2][3].color != self.color:
                        conf[self.position[0] - 1][self.position[1] - 2][0].config(
                            bg=b[conf[self.position[0] - 1][self.position[1] - 2][1]])
                ...
                if self.position[0] > 1 and self.position[1] > 0:
                    ...
                    if conf[self.position[0] - 2][self.position[1] - 1][2] == False and \
                            conf[self.position[0] - 2][self.position[1] - 1][3].color != "" and \
                            conf[self.position[0] - 2][self.position[1] - 1][3].color != self.color:
                        conf[self.position[0] - 2][self.position[1] - 1][0].config(
                            bg=b[conf[self.position[0] - 2][self.position[1] - 1][1]])
        ...
        if self.color == tour:
            if self.click == 0:
                ...
                if self.color == 'White':
                    ...
                    if self.position[0] < 6:
                        conf[self.position[0] + 2][self.position[1]][0].config(
                            bg=conf[self.position[0] + 2][self.position[1]][1])
...
def rulez(v):
    ...
    for i in whites:
        i.clicka(1)
        if conf[black_king.position[0]][black_king.position[1]][0].cget("bg") == b[
            conf[black_king.position[0]][black_king.position[1]][1]]:
            black_king.check += 1
    checker()
    tour = "Black"
    ...
    for i in blacks:
        i.clicka(1)
        if conf[white_king.position[0]][white_king.position[1]][0].cget("bg") == b[
            conf[white_king.position[0]][white_king.position[1]][1]]:
            white_king.check += 1
